        ...
        <div class="container-fluid">
            ...
            <div class="bg-success rounded-4 p-4 mt-3">
                ...
                <div class="mt-4 d-flex bg-dark p-3" style="box-shadow: -10px -10px 0px rgb(171, 171, 171);">
                    <h3 class="text-white">Daftar jurusan</h3>
                ...
                <!-- AKHIR HEADER TABLE -->
                <!-- TABLE DAFTAR KElAS DAN JURUSAN -->
                <div class="p-3">
                        ...
                        <tr class="text-center">
                            ...
                            <td class="gap-2">
                                <button class="bg-transparent border-0">
                                    <a href="../aksi.php?id=<?= $data['id'] ?>&paramTable=kelas&paramAksi=delete&paramHalaman=daftar_jurusan.php&keyword=<?= $keyword ?>&urut=<?= $urut ?>" onclick="return confirm('Yakin ingin menghapus guru?')">
                                        <img src="../icon/delete1.png" width="30rem" alt="hapus">
                                    </a>
                                </button>
                                <button class="bg-transparent border-0" type="button" data-bs-target="#editkelasjurusan<?= $data['id'] ?>" data-bs-toggle="modal">
                                    <img src="../icon/edit1.png" width="30rem" alt="edit">
                                </button>

                                            <!-- AWAL POP UP EDIT -->
                                <div class="modal fade" data-bs-backdrop="static" tabindex="-1" id="editkelasjurusan<?= $data['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-scrollable">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body bg-secondary">
                                                <form action="../aksi.php?id=<?= $data['id'] ?>&paramTable=kelas&paramAksi=edit&paramHalaman=daftar_jurusan.php&keyword=<?= $keyword ?>&urut=<?= $urut ?>" method="post">
                                                    <div class="">
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" aria-label="Default select example" name="angkatan" id="angkatan">
                                                                <option selected value="<?= $data['angkatan'] ?>"><?= $data['angkatan'] ?></option>
                                                                    <?php foreach($dataAngkatan as $data3) : ?>
                                                                        <?php if($data3['angkatan'] != $data['angkatan']) : ?>
                                                                            <option value="<?= $data3['angkatan'] ?>"><?= $data3['angkatan'] ?></option>
                                                                        <?php endif ; ?>
                                                                    <?php endforeach ; ?>
                                                            </select>
                                                        </div>
