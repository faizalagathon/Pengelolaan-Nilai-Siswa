    ...
    <div class="">
        ...
        <ul class="nav justify-content-center bg-light">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle fw-bold text-dark text-decoration-none" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="../icon/add-user.png" class="ms-4" width="40rem" alt=""><br>
                    Tambah Akun
                </a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="tambah_akun_wali.html">Wali Kelas</a></li>
                  <li><a class="dropdown-item" href="tambah_akun_Gmapel.html">Guru Mapel</a></li>
                  <li><a class="dropdown-item text-decoration-underline" href="tambah_akun_murid.html">Murid</a></li>
                </ul>
              </li>
            <li class="nav-item">
