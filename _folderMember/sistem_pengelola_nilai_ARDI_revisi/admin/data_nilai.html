...
<html lang="en">
  ...
  <body>
    <div class="">
        <nav class="navbar bg-dark judul mb-2">
            <div class="container">
          ...
          <div class="">
            <a href="mapel_s1.html" class="ms-2">
                <button class="btn btn-light">
                    <img src="../icon/back.png" width="20rem" alt="">
                </button>
            </a>
            <table class="table table-light table-striped w-75 m-auto">
                <div class="dropdown mb-3 mt-2" style="margin-left: 11rem;">
