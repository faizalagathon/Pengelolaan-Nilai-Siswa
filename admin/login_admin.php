...
<body>
  <!-- <form action="../aksi.php?paramTable=admin&paramAksi=login_admin" method="post" class="m-auto bg-dark mb-1 mt-5 p-3 rounded-5"> -->
  <form action="../aksi_login.php?ParamAksi=login&ParamTable=admin&ParamCek=cekpass&ParamError=login_admin" method="post" class="m-auto bg-dark mb-1 mt-5 p-3 rounded-5">
    ...
    <?php if (isset($_GET['coba'])) : ?>
      <div class="alert alert-warning alert-dismissible fade show" role="alert">
        <strong>Nama atau Password salah!</strong>
    ...
    <div class="mb-3 px-3">
      ...
      <input type="password" name="password" class="form-control border-0 border-bottom" id="password">
    </div>
    <br>
    <div class="d-grid gap-2">
      <!-- <input type="hidden" name="login" value="login"> -->
      <button type="submit" name="login_admin" class="btn rounded-pill text-white fw-bold login">Login</button>
    </div>
