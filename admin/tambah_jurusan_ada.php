            ...
            <div class="toast-container position-fixed bottom-0 end-0 p-3">
                <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                    ...
                    <?php switch($_GET['paramStatusAksi']) { 
                        case "gagalTambahAngkatan" : ?> <strong class="me-auto">Gagal </strong> Tambah Kelas, Isi Terlebih Dahulu Angkatannya. <?php break ; ?>
                        <?php case "gagalTambahJurusan" :?> <strong class="me-auto">Gagal </strong> Tambah Kelas, Isi Terlebih Dahulu Jurusannya. <?php break ; ?>
